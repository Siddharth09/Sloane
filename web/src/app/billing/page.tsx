...
const PLAN_CARDS: { id: PlanId; name: string; price: string; blurb: string; features: string[]; wash: string; accent: string }[] = [
  {
    ...
    price: "$0",
    blurb: "Try it out",
    features: ["10,000 characters/month", "All preset voices", "No video cloning"],
    wash: "bg-surface",
    accent: "text-muted",
  },
  {
    ...
    features: ["200,000 characters/month", "Clone any voice", "No video cloning yet"],
  ...
  },
  {
    ...
    features: ["750,000 characters/month", "Clone any voice", "30 seconds/month video cloning"],
